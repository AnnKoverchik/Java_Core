...
class Task14 {
    ...
    static String getZodiacYearName(int year) {
        ...
        switch (year%12) {
            case 0: monthName="Monkey";
                break;
            case 1: monthName="Rooster";
                break;
            case 2: monthName="Dog";
                break;
            case 3: monthName="Pig";
                break;
            case 4: monthName="Rat";
                break;
            case 5: monthName="Ox";
                break;
            case 6: monthName="Tiger";
                break;
            case 7: monthName="Rabbit";
                break;
            case 8: monthName="Dragon";
                break;
            case 9: monthName="Snake";
                break;
            case 10: monthName="Horse";
                break;
            case 11: monthName="Ram";
                break;
         }
        return monthName;
    }
