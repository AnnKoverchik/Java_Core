...
class Task10 {
    ...
    static int getNumberStation(int firstFuelReserves, int secondFuelReserves, int thirdFuelReserves) {
        ...
        if (((firstFuelReserves<secondFuelReserves)&&(firstFuelReserves<thirdFuelReserves))||
                ((firstFuelReserves==secondFuelReserves)&&(secondFuelReserves==thirdFuelReserves))||
                ((firstFuelReserves==secondFuelReserves)&&(firstFuelReserves<thirdFuelReserves))||
                ((firstFuelReserves==thirdFuelReserves)&&(firstFuelReserves<secondFuelReserves))){
            numberFuel=1;
        }
        else {
            if(((secondFuelReserves<firstFuelReserves)&&(secondFuelReserves<thirdFuelReserves))||
                    (secondFuelReserves==thirdFuelReserves)&&(secondFuelReserves<firstFuelReserves)){
                numberFuel=2;
            }
            else {
