...
class Task06 {
    ...
    static String getResult(int tanksKilledFirstPlayer, int tanksKilledSecondPlayer) {
        ...
        if (tanksKilledFirstPlayer==tanksKilledSecondPlayer){
           pointSecondPlayer=pointFirstPlayer=tanksKilledFirstPlayer*KILL_POINT;
        }
        else {if (tanksKilledFirstPlayer>tanksKilledSecondPlayer){
                pointFirstPlayer=tanksKilledFirstPlayer*KILL_POINT+BONUS_POINT;
                pointSecondPlayer=tanksKilledSecondPlayer*KILL_POINT;
                }
              else {
                pointFirstPlayer=tanksKilledFirstPlayer*KILL_POINT;
                pointSecondPlayer=tanksKilledSecondPlayer*KILL_POINT+BONUS_POINT;
                }
        }
